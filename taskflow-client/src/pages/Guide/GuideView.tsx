...
export const GuideView: React.FC = () => {
  ...
  const sections: GuideSection[] = [
    ...
    {
      title: 'Month Calendar & Day Planner',
      icon: '📅',
      badge: 'Calendar View',
      gradient: 'from-emerald-600 to-teal-600',
      lightGradient: 'from-emerald-500 to-teal-500',
      description: 'Navigate task history and plan upcoming schedules using the full-month calendar and day-wise planner.',
      steps: [
        'Click any day on the calendar to load, edit, or add tasks planned for that specific day.',
        'Drag and drop tasks from the planner list directly onto any day cell in the calendar to reschedule them.',
        'On mobile/touch devices, press and hold (long-press for 250ms) a task card until you feel a haptic vibration feedback, then drag and release it over any calendar cell to reschedule it.',
        'The mobile drag-and-drop automatically locks screen scrolling while active, allowing smooth target positioning.',
      ],
      tips: [
        'A small colored dot appears under calendar dates: gold for important tasks, and blue for standard tasks, mapping your workload.',
        'Dragging and rescheduling tasks automatically syncs the update with the backend database instantly.',
      ],
    },
    {
